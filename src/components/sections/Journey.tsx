        ...
        <motion.div style={{ x }} className="flex gap-12 md:gap-32 px-12 md:px-24">
          <div className="min-w-[300px] md:min-w-[600px] flex flex-col justify-center">
            <motion.p
              ...
              className="text-gold-500/60 uppercase tracking-[0.6em] text-[10px] mb-4"
            >
              Chapter 2: The Spark
            </motion.p>
            <motion.h2
          ...
          {storySteps.map((step, index) => (
            ...
            >
              <div className="glass p-10 rounded-3xl relative overflow-hidden group-hover:bg-white/[0.07] transition-all duration-700">
                ...
                <span className="text-gold-500/40 font-serif text-6xl absolute top-6 right-8 opacity-20 pointer-events-none">
                  {step.year}
                </span>

                <div className="relative z-10">
                  <span className="text-gold-500 uppercase tracking-widest text-[10px] mb-6 block font-bold">
                    {step.category}
                  </span>
                  <h3 className="text-3xl font-serif mb-6 text-white group-hover:text-gold-200 transition-colors duration-500">
                    {step.title}
                  </h3>
                ...
                <div className="mt-8 h-px w-full bg-gradient-to-r from-gold-500/20 to-transparent" />
              </div>
            </motion.div>
          ))}
        </motion.div>
